  ...
  function Navbar() {
    return(
      ...
      {isMobile ? (
       ...
       <Tabs sx={{background: '#5b8441', width: '100%'}} value={tab} onChange={handleChange} >

       <Tab label="Home" onMouseEnter={(event) => handleChange(event, 0)} onMouseLeave={(event) => handleChange(event, tab)} onClick={(event) => handleClick(event, "home")} sx={{ marginLeft: 5,fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Tools" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 1)} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Gallery" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 2)} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Reports" onMouseEnter={(event) => handleChange(event, 3)} onClick={(event) => handleClick(event, "reports")} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Other" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 4)} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Contact" onMouseEnter={(event) => handleChange(event, 5)} onClick={(event) => handleClick(event, "contactPage")} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
       <Tab label="Data Entry" onMouseEnter={(event) => handleChange(event, 6)} onClick={(event) => handleClick(event, "submission")} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
  ...
  return (
    ...
    <Grid onMouseLeave={handleClose} sx={{width: '100%', padding: 0 }}>
      ...
      {isMobile ? (
       ...
       <Tabs sx={{background: '#5b8441', width: '100%'}} value={tab} onChange={handleChange} TabIndicatorProps={{style: {backgroundColor:'black', color:'black'}}} >

       <Tab label="Home" onMouseEnter={(event) => handleChange(event, 0)} onMouseLeave={(event) => handleChange(event, tab)} onClick={(event) => handleClick(event, "home")} sx={{ marginLeft: 5,fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }, ":active": { color: "black" }}}/>
       <Tab label="Tools" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 1)} sx={{fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }}}/>
       <Tab label="Gallery" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 2)} sx={{fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }}}/>
       <Tab label="Reports" onMouseEnter={(event) => handleChange(event, 3)} onClick={(event) => handleClick(event, "reports")} sx={{fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }}}/>
       <Tab label="Other" icon={<ArrowDropDownIcon fontSize={'medium'}/>} iconPosition="end" onMouseEnter={(event) => handleChange(event, 4)} sx={{fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }}}/>
       <Tab label="Contact" onMouseEnter={(event) => handleChange(event, 5)} onClick={(event) => handleClick(event, "contactPage")} sx={{fontSize: '120%', color: "white",fontWeight: 'bold',":hover": { color: "black" }}}/>
       <Tab label="Data Entry" onMouseEnter={(event) => handleChange(event, 6)} onClick={(event) => handleClick(event, "submission")} sx={{fontSize: '120%', fontWeight: 'bold'}}/>
